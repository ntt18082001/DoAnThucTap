 ...
 * - Khi dùng function kiểm tra kiểu này, ngoài việc kiểm tra về mặt logic cấu trúc,
 *
 * So sánh với phương pháp ép kiểu "Type Assertions" thì ép kiểu chúng giúp ta đúng về mặt Type, chưa chắc về logic
 */

...
namespace ChatServer.Api.Common.Mailer
{
	public class AppMailer
	{
		...
		public static void SendToList(AppMailSender sender, IEnumerable<AppMailReceiver> recivers, AppMailConfiguration mailConfig)
		{
		...
		public static void SendToListInBackground(AppMailSender sender, IEnumerable<AppMailReceiver> recivers, AppMailConfiguration mailConfig)
		{
			Thread thMail = new Thread(() =>
			{
